...
class SolverUsingHyuns : public robotis_manipulator::Kinematics
{
private:
	bool with_gripper_ = false;

	void forwardSolverUsingChainRule(Manipulator *manipulator, Name component_name);
	bool inverseSolverUsingHyuns(Manipulator *manipulator, Name tool_name, Pose target_pose, std::vector<JointValue>* goal_joint_value);
